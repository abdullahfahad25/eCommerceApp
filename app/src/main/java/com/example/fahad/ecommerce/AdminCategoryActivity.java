...
public class AdminCategoryActivity extends AppCompatActivity {
    ...
    private ImageView sportsTShirts;
    private ImageView femaleDresses;
    private ImageView sweathers;

    private ImageView glasses;
    private ImageView hatsCaps;
    private ImageView walletsBagsPurses;
    private ImageView shoes;

    private ImageView headPhonesHandFree;
